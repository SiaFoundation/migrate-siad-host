module go.sia.tech/migrate-siad-host
...
require (
	...
	go.sia.tech/hostd v1.0.0
	go.sia.tech/siad v1.5.10-0.20240110184031-53aed5497204 // this uses a specific siad commit that overrides the testing sector size. DO NOT CHANGE
